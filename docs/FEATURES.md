...
The full pipeline below — repair and debris filters, smooth, simplify, close
holes, remesh, and UV-atlas generation — is also available from Python via the pip-installable
