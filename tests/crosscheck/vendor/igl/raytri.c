...
// Vendored copy for reproducible CI builds.
// Source: libigl v2.6.0, include/igl/raytri.c
// This file is NOT installed by the vcpkg libigl port (packaging gap).
// Vendored here so the crosscheck build does not depend on vcpkg buildtrees.
// Original: Tomas Möller–Ben Trumbore, public domain (Möller–Trumbore algorithm).
// libigl repo: https://github.com/libigl/libigl/blob/main/include/igl/raytri.c
